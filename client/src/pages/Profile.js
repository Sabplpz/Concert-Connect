...
<div className="w-full py-10 px-10">
      <div>
        <div className="sm: flex space-x-7 md:items-start items-center">
          <div className="mb-10">
            <img className="rounded-full mr-8 md:w-36 ring ring-primary ring-offset-base-100 ring-offset-2" src={userIcon} alt="user profile pic"/>
          </div>
          <div>
            <h1 className="text-4xl font-bold my-2">Miamreid</h1>
            <p className="text-base tracking-wide mb-6 md:max-w-lg">100 followers</p>
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8 mt-10">
        <div>
          {/* Top artists table */}
          <div className="collapse-title bg-base-200 text-xl">
            Top Artists</div>
        ...
        <table className="table">
          ...
          <tbody>
            ...
            <tr className="hover">
              ...
              <td>Quality Control Specialist</td>
              <td>Blue</td>
              <th><button className="btn btn-ghost btn-xs">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="fill-white" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" /></svg>
Favorite</button></th>
            </tr>
            {/* row 2 */}
            <tr className="hover">
